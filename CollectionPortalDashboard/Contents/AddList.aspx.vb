...
Public Class AddList
    ...
    Private Sub AccessForm()
        ...
        txtUIDCollector.Text = AccFormUID.Trim + " - " + AccFormUserName
        'ADMINISTRATOR
        'INPUT
        If AccForm = "IPT" Then
            btnAccept.Visible = False
            dvColStatus.Visible = False
    ...
    Public Sub LoadData()
        Try
            ...
            ds = DataAccess.AccountAccess.GetDataCollectionByParam(ID, Access)
    ...
    Protected Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        Try
            ...
            If objmColHeader.ErrorCode.Trim = "0" Then
                ...
                End If
            Else
                Page.ClientScript.RegisterStartupScript(Me.GetType(), "Script", "MessageError('Info','" + objmColHeader.ErrorDescription + "');", True)
    ...
    Protected Sub btnBackCancel_Click(sender As Object, e As EventArgs) Handles btnBackCancel.Click
        Response.Redirect("~/Contents/AddList.aspx")
    End Sub
    ...
    Private Sub btnAccept_Click(sender As Object, e As System.EventArgs) Handles btnAccept.Click
        Try
            ...
            DataAccess.AccountAccess.AcceptCollection(txtColNumber.Text, objmAccept)
    ...
    Private Sub btnAdd_Click(sender As Object, e As System.EventArgs) Handles btnAdd.Click
        ...
        btnAdd.Visible = False
        If Session("user").uaccess = "RVW" Then
            btnAccept.Visible = False
        End If
    End Sub
End Class