<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/NewSite.Master"
    CodeBehind="AddForm.aspx.vb" MaintainScrollPositionOnPostback="true" Inherits="CollectionPortalDashboard.AddForm" %>
        ...
        <div class="container-fluid">
            <div class="card card-info" id="headerdetail">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-10">
                            <p class="float-left" style="font-size:18px; font-weight:lighter; margin:0px; color:#fff">Form List</p>
                        </div>
                        <div class="col-sm-2">
                            <span class="input-group-append  float-right">
                                        <asp:LinkButton ID="btnAdd" runat="server" CssClass="btn btn-sm btn-flat btn-primary" Width="150px" Height="30px">
                                            <i class="fas fa-plus-square" style="margin-right:2px"></i> Add Form
                                        </asp:LinkButton>
                                    </span>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="btn-group" runat="server">
                                    ...
                                    <span class="input-group-append">
                                        <asp:LinkButton ID="btnPrint" runat="server" CssClass="btn btn-success btn-sm btn-flat mr-2" Width="100px" Height="30px">
                                            <i class="fas fa-print" style="margin-right:2px"></i> Print
                                        </asp:LinkButton>
                                    </span>
                                </div>
                            </div>
