<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/NewSite.Master"
    CodeBehind="AddList.aspx.vb" MaintainScrollPositionOnPostback="true" Inherits="CollectionPortalDashboard.AddList" %>
        ...
        <div class="container-fluid">
            <div class="card card-info" id="headerdetail">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-10">
                            <p class="float-left" style="font-size:18px; font-weight:lighter; margin:0px; color:#fff">Collection List</p>
                        </div>
                        <div class="col-sm-2">
                    ...
                    <asp:Panel runat="server" ID="PnlData" Visible="true">
                        <asp:GridView ID="gvData" EmptyDataText="No Records Found" runat="server" AllowPaging="false"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="totalamount" DataFormatString="{0:N2}" ItemStyle-HorizontalAlign="Right"  HeaderText="Total Amount IDR" />
                                ...
                                <div class="btn-group" runat="server">
                                    ...
                                    <span class="input-group-append">
                                        <asp:LinkButton ID="btnUpdate" runat="server" CssClass="btn btn-info btn-sm btn-flat mr-2" Width="150px" Height="30px" Visible="false">
                                            <i class="fas fa-plus-square" style="margin-right:2px"></i> Update Collection
                                        </asp:LinkButton>
                                    </span>
                                    <span class="input-group-append">
