...
Public Class AddForm
    ...
    Public Sub LoadData()
        Try
            ...
            ds = DataAccess.AccountAccess.GetDataCollectionFormByParam(ID, Access)
    ...
    Protected Sub fncInsertUpdateCollection(strCond As String)
        Try
    ...
    Protected Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        fncInsertUpdateCollection("Create")
    End Sub

    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        fncInsertUpdateCollection("Update")
    End Sub
    ...
    Private Sub btnSelectGrid_Click(sender As Object, e As System.EventArgs) Handles btnSelectGrid.Click
        Try
            ...
            If ds.ExtendedProperties("ErrorCode") = "0" Then
                ...
                txtVANumber.Text = ds.Tables(0).Rows(0).Item("vanumber").ToString.Trim
