<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmLookupCorrID.aspx.vb" Inherits="CollectionPortalDashboard.frmLookupCorrID" %>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-3 form-control-sm" style="font-weight: 400">
                                Correspondent ID</label>
                            <div class="col-9">
                                <div class="input-group">
                                    <asp:TextBox ID="txtCorrID" runat="server" MaxLength="25" CssClass="form-control form-control-sm" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <label class="col-3 form-control-sm" style="font-weight: 400">
                                Correspondent Name</label>
                            <div class="col-9">
                                <div class="input-group">
                                    <asp:TextBox ID="txtCorrName" runat="server" CssClass="form-control form-control-sm" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                ...
                <div class="col-md-6">
                    <asp:GridView ID="gvData" runat="server" AllowPaging="True" PageSize="6" CssClass="table table-sm table-bordered"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderStyle-HorizontalAlign="Center" DataField="client_id" HeaderText="Corr ID" />
                            <asp:BoundField HeaderStyle-HorizontalAlign="Center" DataField="name" HeaderText="Corr Name" />
                        </Columns>
